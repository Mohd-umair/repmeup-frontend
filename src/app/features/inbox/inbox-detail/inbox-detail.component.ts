...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, FormsModule, MediaSelectorModalComponent, AiChatBubbleIconComponent],
...
export class InboxDetailComponent implements OnChanges, OnInit, OnDestroy {
  ...
  private serverReplySupersedesOptimistic(
    opt: Pick<IOptimisticReply, 'content' | 'sentAt' | 'whatsappTemplatePayload'>,
    serverReply: {
      content?: string;
      sentAt?: Date;
